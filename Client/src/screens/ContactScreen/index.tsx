export default function ContactScreen() {
  return (
    <section className="w-full flex flex-col items-center justify-center">
      <div className="bg-gray-600 bg-opacity-80 h-[20vh] w-full flex items-center justify-center flex-col">
      ...
      <section className="bg-gray-100 w-full bg-opacity-80">
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <form action="send" className="space-y-8">
            ...
            <button
              type="submit"
              className="py-3 bg-red-800 px-5 text-sm font-medium text-center text-white rounded-lg sm:w-fit hover:bg-red-600 focus:ring-4 
