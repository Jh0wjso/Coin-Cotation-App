                ...
                <View style={styles.inputContent}>
                    <AutocompleteDropdown
                        ...
                        dataSet={[
                            ...
                            { id: 'AMFT', title: 'Aston Martin'},
                            { id: 'AMP', title: 'Amp'},
                            { id: 'ANKR', title: 'ANKR'},
                            { id: 'ANT', title: 'Aragon'},
                            { id: 'APE', title: 'ApeCoin'},
                            { id: 'ARGFT', title: 'A.F. Association'},
                            { id: 'ASRFT', title: 'AS Roma'},
                            { id: 'ATLAS', title: 'Star Atlas'},
                            { id: 'ATOM', title: 'Cosmos'},
                            //
                            { id: 'SCCPFT', title: 'Corinthians'},
                            { id: 'VERDAO', title: 'S.E. Palmeiras'},
                            { id: 'MENGOFT', title: 'Flamengo'},
                            { id: 'CITYFT', title: 'Manchester City FC'},
                            { id: 'BARFT', title: 'FC Barcelona' },
