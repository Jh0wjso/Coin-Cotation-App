      ...
      <View style={styles.infoContainer}>
        <View style={styles.infoContent}>
          ...
          <Text style={styles.infomation}>
            A maior venda, representa a maior venda da moeda no dia até o
            momento da cotação.
          </Text>
        </View>
        <View style={styles.infoContent}>
          ...
          <Text style={styles.infomation}>
            A Ultima cotação, representa a ultima cotação da moeda no dia até o
            momento da cotação.
          </Text>
        </View>
        <View style={styles.infoContent}>
          ...
          <Text style={styles.infomation}>
            O valor abertura, representa o preço por unidade de abertura de
            negociação no dia até o momento da cotação.
          </Text>
        </View>
        <View style={styles.lastInfoContent}>
          <Text style={styles.infoName}>Volume</Text>
          <Text style={styles.infomation}>
            O volume, representa a quantidade negociada nas ultimas 24 horas até
            a cotação.
          </Text>
        </View>
      </View>
