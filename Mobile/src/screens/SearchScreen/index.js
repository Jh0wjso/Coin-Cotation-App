      ...
      <View style={styles.inputContainer}>
          ...
          <View style={styles.inputContent}>
            <AutocompleteDropdown
              ...
              dataSet={[
                ...
                {
                  id: config.alchemypay.initials,
                  title: config.alchemypay.name,
                },
                ...
                {
                  id: config.braintrust.initials,
                  title: config.braintrust.name,
                },
                ...
                {
                  id: config.aavegotchi.initials,
                  title: config.aavegotchi.name,
                },
                ...
                {
                  id: config.highstreet.initials,
                  title: config.highstreet.name,
                },
                ...
                {
                  id: config.immutableX.initials,
                  title: config.immutableX.name,
                },
                {
                  id: config.intermilan.initials,
                  title: config.intermilan.name,
                },
        ...
        <View style={styles.suggestions}>
          <View style={styles.contentButton}>
            ...
            <Text style={styles.textCoinName}>Bitcoin</Text>
          </View>
        ...
        <View style={styles.suggestions}>
          <View style={styles.contentButton}>
            ...
            <Text style={styles.textCoinName}>Apecoin</Text>
          </View>
          ...
          <View style={styles.contentButton}>
            ...
            <Text style={styles.textCoinName}>FileCoin</Text>
          </View>
